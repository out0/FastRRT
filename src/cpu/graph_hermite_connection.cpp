...
extern  bool set(int4 *graph, float4 *graphData, long pos, float heading, int parent_x, int parent_z, float cost, int type, bool override);
 ...
 float cudaHermite(int4 *graph, float4 *graphData, float3 *frame, float *classCosts, int *searchSpaceParams, float max_curvature, int x, int z, int goal_x, int goal_z, float goal_heading, bool fillInterpolation, bool computeDistance)
{
 ...
 float canConnectToGoalUsingHermite(int4 *graph, float4 *graphData, float3 *frame, float *classCosts, int *searchSpaceParams, float max_curvature, int x, int z, int goal_x, int goal_z, float goal_heading) {
 ...
 float interpolateNodesUsingHermite(int4 *graph, float4 *graphData, float3 *frame, float *classCosts, int *searchSpaceParams, float max_curvature, int x, int z, int goal_x, int goal_z, float goal_heading) {
